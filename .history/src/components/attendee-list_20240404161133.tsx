    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-3">
        ...
        <div className=" w-72 px-3 py-1.5 border border-white/10 rounded-lg flex items-center gap-3 text-sm">
          ...
          <input onChange={onSearchInputChanged} className="bg-transparent flex-1 outline-none border-0 p-0 text-sm focus:right-0" type="search" placeholder="Buscar participante..."  />
        </div>
      </div>
